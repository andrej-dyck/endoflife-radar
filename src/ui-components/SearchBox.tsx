    ...
    <div className="flex">
      ...
      <div className="relative w-full">
        <input type="search" id="search" ref={ref}
          className="block w-full rounded-lg border border-element-border bg-element-bg p-2 placeholder:text-placeholder-text hover:ring hover:ring-focus focus:border-focus focus:ring focus:ring-focus"
          value={value}
        ...
        />
        <div
          className="absolute end-0 top-0 flex h-full flex-col place-content-center rounded-e-lg border border-primary-element bg-primary-element p-2 focus:ring-4 focus:ring-focus"
        >
